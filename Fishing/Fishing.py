...
class NoticeDialog(QDialog):
    ...
    def initUI(self, parent):
        ...
        <p>이 프로그램은 집중해서 낚시하기 전용입니다. <br>준비 아이콘을 감지 후 캐스팅하고, 성공 또는 실패를 이미지로 판별해 낚시를 진행합니다.</p>
        <hr>
        <p><b>1. 시작 위치</b></p>
        <ul>
        ...
        <ul>
            <li>상단의 창 크기 맞추기 버튼으로 게임 창 크기를 맞춰주세요.</li>
            <li>낚시터 입장 후 캐릭터가 더 이상 앞으로 가지 않는 자리에서 시작하세요.</li>
            <li>이미지 감지 방식이라 게임 창이 최소화 되면 안 됩니다.</li>
        </ul>
        <p><b>3. 주의사항</b></p>
        <ul>
            <li>펫 상호작용 때문에 오류가 잦으니 펫은 꼭 넣고 진행해주세요.</li>
